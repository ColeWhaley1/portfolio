                ...
                <div className="flex justify-center"> 
                    <div className="flex space-x-8 m-2 items-center">
                        ...
                        <div className="text-black">
                            ...
                            <div className="rounded-md bg-gray-300 p-2 mt-4 overflow-auto max-h-40 dark:bg-gray-200 max-w-screen-md">
                                <ul>
                ...
                <div className="flex justify-center"> 
                    <div className="flex space-x-8 m-2 items-center">
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer">
                            <img src={CarolinaEastLogo} alt="Carolina East logo" className="shadow-md h-60 w-60 rounded-md hover:scale-105 mt-4" />
                        </a>
                        <div className="text-black">
                            <div className="flex space-x-2 items-baseline">
                                <p className="font-bold text-lg">Role:</p>
